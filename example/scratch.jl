...
b_df, b_highlights, b_freq = create_tables(
    businesses,
    response2["business_histogram"],
    ["legal_name", "addr", "addr2", "city", "zip"],
)
pretty_table(b_df; highlighters = Tuple(b_highlights))
